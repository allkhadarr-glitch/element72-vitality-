...
export default function FounderPage() {
  return (
    <div className="bg-earth">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center px-6 border-b border-cream/[0.08] overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <blockquote className="font-serif text-2xl md:text-4xl text-cream/78 leading-relaxed italic mb-14 animate-fade-up delay-200">
          ...
          <div className="flex items-center justify-center gap-5 animate-fade-up delay-300">
            ...
            <p className="font-sans text-cream/58 text-[10px] tracking-[0.4em] uppercase">Founder, Element 72 Vitality &nbsp;·&nbsp; Nairobi, Kenya</p>
            <div className="h-px w-8 bg-gold/30" />
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-24 md:py-36 border-b border-cream/[0.08]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-12 md:gap-24">
          ...
          <div className="reveal reveal-d2 flex flex-col gap-6">
            <p className="font-sans text-cream/78 text-base md:text-lg leading-relaxed">
            ...
            <p className="font-sans text-cream/58 text-base leading-relaxed">
      ...
      <section className="px-6 py-24 md:py-36 border-b border-cream/[0.08] bg-earth-card">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 reveal">
            ...
            <h2 className="font-serif text-3xl md:text-4xl text-cream max-w-lg leading-snug">The principles behind the brand.</h2>
          </div>
          <div className="flex flex-col divide-y divide-cream/[0.08]">
            {beliefs.map((b, i) => (
              <div key={b.label} className={`py-12 md:py-16 grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-24 reveal reveal-d${i + 1}`}>
                ...
                <p className="font-sans text-cream/58 text-base leading-relaxed">{b.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="px-6 py-24 md:py-36 border-b border-cream/[0.08]">
        <div className="max-w-4xl mx-auto reveal">
          ...
          <h2 className="font-serif text-3xl md:text-5xl text-cream leading-[1.15] mb-10">
            East Africa as a source of premium global wellness.
          </h2>
          <p className="font-sans text-cream/58 text-base leading-relaxed max-w-2xl">
      ...
      <section className="px-6 py-24 md:py-36 bg-earth-card">
        <div className="max-w-xl mx-auto text-center reveal">
          <h2 className="font-serif text-3xl md:text-4xl text-cream mb-8 leading-snug">Build this with us.</h2>
