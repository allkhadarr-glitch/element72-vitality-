    ...
    <div className="bg-earth">
      ...
      <div className="border-y border-cream/[0.08] py-4 overflow-hidden bg-earth-card">
        <div className="flex animate-marquee whitespace-nowrap">
          {[0, 1].map(i => (
            <span key={i} className="font-sans text-[13px] tracking-[0.4em] text-cream/60 uppercase">
      ...
      <section className="px-6 py-28 md:py-40 max-w-4xl mx-auto">
        <div className="reveal">
          <p className="font-sans text-[12px] tracking-[0.45em] text-gold uppercase mb-10">The Name</p>
      ...
      <section className="px-6 pb-28 md:pb-40 border-t border-cream/[0.08]">
        <div className="max-w-7xl mx-auto">
          <div className="pt-16 md:pt-24 mb-16 reveal">
            <p className="font-sans text-[12px] tracking-[0.45em] text-gold uppercase mb-4">Arriving Soon</p>
            ...
            {products.map((p, i) => (
              ...
              >
                ...
                <div className="p-10 md:p-14 flex flex-col flex-1">
                  <p className="font-sans text-[11px] tracking-[0.35em] text-cream/40 uppercase mb-8">{p.coords}</p>
                  <div className="flex items-center justify-between mb-10">
                    <span className="font-sans text-[11px] tracking-[0.35em] text-gold uppercase border border-gold/30 px-3 py-1.5">
                      Coming Soon
                    </span>
                    <span className="font-sans text-[11px] tracking-[0.25em] text-cream/45 uppercase">{p.status}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 text-cream/35 group-hover:text-gold transition-colors duration-300">
                    <span className="font-sans text-[12px] tracking-[0.4em] uppercase">Learn more</span>
      ...
      <section className="px-6 py-28 md:py-40 border-t border-cream/[0.08] bg-earth-card">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 reveal">
            <p className="font-sans text-[12px] tracking-[0.45em] text-gold uppercase mb-4">Our Standard</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-cream/[0.08]">
            {pillars.map((p, i) => (
              <div key={p.label} className={`bg-earth-card p-10 md:p-12 reveal reveal-d${i + 1}`}>
                ...
                <p className="font-sans text-cream/80 text-base leading-relaxed">{p.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="px-6 py-28 md:py-40 border-t border-cream/[0.08]">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 reveal">
            <p className="font-sans text-[12px] tracking-[0.45em] text-gold uppercase mb-4">Follow the Journey</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-cream/[0.08] mb-10">
            ...
            <a href="https://tiktok.com/@element72vitality" target="_blank" rel="noopener noreferrer"
              ...
              <p className="font-sans text-[12px] tracking-[0.4em] text-gold uppercase">TikTok</p>
              ...
              <p className="font-sans text-[12px] tracking-[0.35em] text-cream/45 uppercase group-hover:text-gold transition-colors duration-200">
                @element72vitality →
              </p>
            </a>
            ...
            <a href="https://instagram.com/element72vitality" target="_blank" rel="noopener noreferrer"
              ...
              <p className="font-sans text-[12px] tracking-[0.4em] text-gold uppercase">Instagram</p>
            ...
            <Link href="/journal/what-is-shilajit"
              ...
              <p className="font-sans text-[12px] tracking-[0.4em] text-gold uppercase">From the Journal</p>
      ...
      <section className="px-6 py-28 md:py-40 border-t border-cream/[0.08]">
        <div className="max-w-3xl mx-auto text-center reveal">
          ...
          <div className="flex items-center justify-center gap-5 mb-10">
            ...
            <p className="font-sans text-cream/65 text-[13px] tracking-[0.3em] uppercase">
      ...
      <section id="join" className="px-6 py-28 md:py-40 border-t border-cream/[0.08] bg-earth-card">
        <div className="max-w-2xl mx-auto text-center reveal">
          ...
          <p className="font-sans text-cream/75 text-lg mb-12 leading-relaxed">
